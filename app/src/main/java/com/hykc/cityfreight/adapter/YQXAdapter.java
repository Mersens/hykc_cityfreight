...
public class YQXAdapter extends RecyclerView.Adapter<YQXAdapter.ViewHolder> {
    private Context mContext;
    private LayoutInflater mInflater;
    private OnItemBtnClickListener listener;
    private List<UWaybill> list;

    public YQXAdapter(Context mContext, List<UWaybill> list){
    ...
    @NonNull
    @Override
    public YQXAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view=mInflater.inflate(R.layout.layout_dfh_item,viewGroup,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(YQXAdapter.ViewHolder holder, final int i) {
       ...
       // setBtnData(holder,uWaybill,i);
        ...
        holder.mTextStatu.setText("已取消");
        holder.mImgStutuType.setImageResource(R.mipmap.icon_statu_ycx);
