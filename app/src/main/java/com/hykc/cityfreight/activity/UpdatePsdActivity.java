...
public class UpdatePsdActivity extends BaseActivity {
    ...
    private void doSave() throws JSONException {
        ...
        String userinfo=SharePreferenceUtil.getInstance(UpdatePsdActivity.this).getUserinfo();
    ...
    private void clearData(){
        ...
        SharePreferenceUtil.getInstance(UpdatePsdActivity.this).setUserinfo(null);
