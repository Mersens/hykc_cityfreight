...
import com.hykc.cityfreight.adapter.YQXAdapter;
...
public class YQXFragment extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        recyclerView.setItemAnimator(null);
        adapter = new YQXAdapter(getActivity(), list);
    ...
    private void initEvent() {
        ...
        adapter.setOnItemBtnClickListener(new YQXAdapter.OnItemBtnClickListener() {
            @Override
    ...
    private void getWaybillInfo(String id, String token) {
        ...
        map.put("type", StatusType.YQX_STATUS + "");
    ...
    public static YQXFragment newInstance(){
        YQXFragment fragment=new YQXFragment();
        return fragment;
    }
}
