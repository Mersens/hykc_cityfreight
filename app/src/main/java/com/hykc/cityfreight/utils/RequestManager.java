...
public class RequestManager {
    ...
    private void init() {
        ...
        builder.interceptors().add(new ReceivedCookiesInterceptor(App.getInstance().getApplicationContext()));
        builder.interceptors().add(new AddCookiesInterceptor(App.getInstance().getApplicationContext()));
